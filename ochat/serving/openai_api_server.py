...
async def create_chat_completion(raw_request: Request, background_tasks: BackgroundTasks):
    ...
    print('11111111111111111111111111 raw_request', raw_request.json())
    print('11111111111111111111111111 request', request)
    ...
    print('11111111111111111111111111 request.messages: ', request.messages)
    ...
    for output in final_res.outputs:
        print('33333333 output.text: ', output.text)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--enable-sys-prompt", default=True, action="store_true")
    ...
    print('1111111111111 eot_tokens:', model.eot_tokens)
