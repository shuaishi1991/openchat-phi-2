...
class ConversationTemplate(BaseModel):
    ...
    def tokenize_conversations(self, conversations: Iterable[Conversation], inference: bool = False, seq_level_weight: bool = False):
        ...
        tmp_role_mappings = dict(zip(role_mappings, [self.role_prefix(*args) for args in role_mappings]))
        print('44444444 tmp_role_mappings: ', tmp_role_mappings)
        ...
        print('44444444 sys_mappings: ', sys_mappings)
        print('44444444 role_mappings: ', role_mappings)
        for text in all_text:
            print('44444444 text: ', len(text))
        print('44444444 eot_tokens_: ', self.eot_tokens_)
        print('44444444 len(conversations): ', len(conversations))
